...
### F5: Apply DB migrations — ✅ Done (local + production) (2026-05-23)
- **Local Docker DB** (`localhost:5432/qs_web`): both migrations applied + E2E verified (POST /api/contact → 200, row written, cleaned up).
